...
/**
 * @brief Fuegt einen Zeiger auf das vorne Listenelement ein
 *
 * @param pPrev Zeiger auf das vorne Listenelement
 */
...
/**
 * @brief Gibt einen Zeiger auf das vorne Listenelement zurueck
 *
 * @return Zeiger auf das vorne Listenelement
 */
